...
[button x=135 y=230 graphic="title/button_start.png" enterimg="title/button_start2.png"  target="gamestart_hirota" keyfocus="1"]
...
*gamestart_hirota
;オリジナルのシナリオファイル(ミラクシア)へジャンプする
@jump storage="scene_hirota.ks"
